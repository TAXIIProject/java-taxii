    ...
    implements Equals, HashCode
{
     ...
     * 
     */
    public QueryType(final List<Object> content, final String formatId) {
        super(content);
    ...
    public QueryType withFormatId(String value) {
        setFormatId(value);
        return this;
    }

    @Override
    public QueryType withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public QueryType withContent(Collection<Object> values) {
        if (values!= null) {
