...
public class ContentBlock implements Equals, HashCode
{
     ...
     * 
     */
    public ContentBlock(final String contentBinding, final AnyMixedContentType content, final XMLGregorianCalendar timestampLabel, final String padding, final Signature signature) {
    ...
    public ContentBlock withContentBinding(String value) {
