...
//        Reader reader = new StringReader(stixStr);
        // JAXBElement st = (JAXBElement)taxiiXml.getJaxbContext().createUnmarshaller().unmarshal(reader);
//        JAXBElement st = (JAXBElement) stixContext.createUnmarshaller().unmarshal(reader);
